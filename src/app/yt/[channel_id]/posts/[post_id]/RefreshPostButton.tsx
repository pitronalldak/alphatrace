...
export default function RefreshPostButton({ postUrl, size = 'sm', title = 'Fetch transcript', showStatus = false }: { postUrl?: string | null; size?: SizeOption; title?: string; showStatus?: boolean }) {
